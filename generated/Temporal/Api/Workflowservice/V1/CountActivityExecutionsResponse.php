...
class CountActivityExecutionsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *           of the groups returned in the response. This number can be smaller than the
     *           total number of activities matching the query.
     *     @type \Temporal\Api\Workflowservice\V1\CountActivityExecutionsResponse\AggregationGroup[] $groups
     *           Contains the groups if the request is grouping by a field.
     *           The list might not be complete, and the counts of each group is approximate.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .temporal.api.workflowservice.v1.CountActivityExecutionsResponse.AggregationGroup groups = 2;</code>
     * @return RepeatedField<\Temporal\Api\Workflowservice\V1\CountActivityExecutionsResponse\AggregationGroup>
     */
