...
class WorkflowExecutionTimeSkippingTransitionedEventAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>bool disabled_after_fast_forward = 2;</code>
     */
    protected $disabled_after_fast_forward = false;
    /**
     ...
     *           The virtual time point that time skipping advanced to.
     *     @type bool $disabled_after_fast_forward
     *           When true, time skipping has been stopped automatically due to a call to fast_forward completing.
     *           (-- api-linter: core::0140::prepositions=disabled
     *               aip.dev/not-precedent: "after" is used to indicate temporal ordering. --)
     ...
     * @return bool
     */
    public function getDisabledAfterFastForward()
    {
        return $this->disabled_after_fast_forward;
    }
